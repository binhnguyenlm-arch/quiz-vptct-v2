...
with accounts as (
 ...
 round(coalesce(55.0*e.correct/nullif(e.total,0),0),2) exam_points,
 round(coalesce(35.0*s.completed/nullif(s.assigned,0),0),2) study_points,
 round(coalesce(10.0*s.early,0),2) early_points
